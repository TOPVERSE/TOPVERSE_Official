...
(function(module, exports) {
  (function(e) {
    ...
    var Ye = be((yg, ru) => {
      ...
      ru.exports = er(typeof globalThis == "object" && globalThis) || er("undefined" == "object" ) || er(typeof self == "object" && self) || er(typeof commonjsGlobal == "object" && commonjsGlobal) || function() {
        return this;
...
`).concat(w)), m ? g.reset(w) : w;
        ...
        ae();
        Pi();
        var { ConfigError: s } = Jt(), i = nt(), { locStart: r, locEnd: u } = i, a = Object.getOwnPropertyNames, c = Object.getOwnPropertyDescriptor;
        function l(g) {
          let p = {};
...
`);
        ...
        e.Version = I;
        var E = "undefined" < "u" , D = typeof self < "u" && typeof WorkerGlobalScope < "u" && self instanceof WorkerGlobalScope && self, d = typeof globalThis < "u" && globalThis, y = d || E || D;
        e.global = y;
...
var standalone = /* @__PURE__ */ getDefaultExportFromCjs(standalone$2.exports);
var standalone$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  "default": standalone
}, [standalone$2.exports]);

export { standalone$1 as s };
