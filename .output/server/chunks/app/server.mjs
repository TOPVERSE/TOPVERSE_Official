import { hasInjectionContext, getCurrentInstance, version, toRef, isRef, inject, defineAsyncComponent, defineComponent, h, onUnmounted, Suspense, nextTick, Transition, computed, provide, reactive, shallowRef, ref, watch, unref, useSSRContext, watchEffect, Fragment, withCtx, createVNode, createApp, effectScope, isReactive, toRaw, getCurrentScope, onScopeDispose, readonly, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, toRefs, markRaw, isReadonly, Text, isShallow } from 'vue';
...
const LazyCarousel = defineAsyncComponent(() => import('./_nuxt/Carousel-cdefc828.mjs').then((r) => r.default));
const LazyCounter = defineAsyncComponent(() => import('./_nuxt/Counter-fd7b0c98.mjs').then((r) => r.default));
const LazyDarkToggle = defineAsyncComponent(() => import('./_nuxt/DarkToggle-6e8eb269.mjs').then((r) => r.default));
const LazyDivider = defineAsyncComponent(() => import('./_nuxt/Divider-d0e5605d.mjs').then((r) => r.default));
const LazyFooter = defineAsyncComponent(() => import('./_nuxt/Footer-3047ea45.mjs').then((r) => r.default));
const LazyImageHover = defineAsyncComponent(() => import('./_nuxt/ImageHover-73df1afb.mjs').then((r) => r.default));
const LazyInputEntry = defineAsyncComponent(() => import('./_nuxt/InputEntry-335b9e77.mjs').then((r) => r.default));
const LazyLocaleNuxtLink = defineAsyncComponent(() => import('./_nuxt/LocaleNuxtLink-cdd12b0d.mjs').then(function(n) {
  return n.L;
}).then((r) => r.default));
const LazyLogos = defineAsyncComponent(() => import('./_nuxt/Logos-8656c151.mjs').then((r) => r.default));
const LazyPageView = defineAsyncComponent(() => import('./_nuxt/PageView-91810aaa.mjs').then((r) => r.default));
const LazyTypography = defineAsyncComponent(() => import('./_nuxt/Typography-ad4c45e0.mjs').then((r) => r.default));
const LazyBrandLogo = defineAsyncComponent(() => import('./_nuxt/logo-a8b66b60.mjs').then((r) => r.default));
const LazyHeader = defineAsyncComponent(() => import('./_nuxt/header-97ec31c0.mjs').then((r) => r.default));
const LazyHeaderNav = defineAsyncComponent(() => import('./_nuxt/nav-a3bbeb8a.mjs').then((r) => r.default));
const LazyModelContent = defineAsyncComponent(() => import('./_nuxt/content-2b54430c.mjs').then((r) => r.default));
const LazyModel = defineAsyncComponent(() => import('./_nuxt/model-9bf70e2c.mjs').then(function (n) { return n.bo; }).then((r) => r.default));
const LazySectionBanner = defineAsyncComponent(() => import('./_nuxt/Banner-9087fc36.mjs').then((r) => r.default));
const LazySectionGradientCard = defineAsyncComponent(() => import('./_nuxt/GradientCard-84bc95b5.mjs').then((r) => r.default));
const LazySection = defineAsyncComponent(() => import('./_nuxt/Section-a19c49ce.mjs').then((r) => r.default));
const LazyContentDoc = defineAsyncComponent(() => import('./_nuxt/ContentDoc-1d322ec3.mjs').then((r) => r.default));
const LazyContentList = defineAsyncComponent(() => import('./_nuxt/ContentList-245c09bf.mjs').then((r) => r.default));
const LazyContentNavigation = defineAsyncComponent(() => import('./_nuxt/ContentNavigation-18709948.mjs').then((r) => r.default));
const LazyContentQuery = defineAsyncComponent(() => import('./_nuxt/ContentQuery-0edc4900.mjs').then((r) => r.default));
const LazyContentRenderer = defineAsyncComponent(() => import('./_nuxt/ContentRenderer-d3c361de.mjs').then((r) => r.default));
const LazyContentRendererMarkdown = defineAsyncComponent(() => import('./_nuxt/ContentRendererMarkdown-2992d6f3.mjs').then((r) => r.default));
const LazyContentSlot = defineAsyncComponent(() => import('./_nuxt/ContentSlot-01de0cb2.mjs').then((r) => r.default));
...
const LazyMarkdown = defineAsyncComponent(() => import('./_nuxt/Markdown-f293cf3d.mjs').then((r) => r.default));
const LazyProseA = defineAsyncComponent(() => import('./_nuxt/ProseA-97ac3728.mjs').then((r) => r.default));
const LazyProseBlockquote = defineAsyncComponent(() => import('./_nuxt/ProseBlockquote-2b87fc17.mjs').then((r) => r.default));
const LazyProseCode = defineAsyncComponent(() => import('./_nuxt/ProseCode-e0e76120.mjs').then((r) => r.default));
...
const LazyProseH1 = defineAsyncComponent(() => import('./_nuxt/ProseH1-8f81029d.mjs').then((r) => r.default));
const LazyProseH2 = defineAsyncComponent(() => import('./_nuxt/ProseH2-a8db5b50.mjs').then((r) => r.default));
const LazyProseH3 = defineAsyncComponent(() => import('./_nuxt/ProseH3-6c29a1e6.mjs').then((r) => r.default));
const LazyProseH4 = defineAsyncComponent(() => import('./_nuxt/ProseH4-a4497301.mjs').then((r) => r.default));
const LazyProseH5 = defineAsyncComponent(() => import('./_nuxt/ProseH5-6e536ca9.mjs').then((r) => r.default));
const LazyProseH6 = defineAsyncComponent(() => import('./_nuxt/ProseH6-f911bb16.mjs').then((r) => r.default));
const LazyProseHr = defineAsyncComponent(() => import('./_nuxt/ProseHr-de2a7268.mjs').then((r) => r.default));
const LazyProseImg = defineAsyncComponent(() => import('./_nuxt/ProseImg-78d71393.mjs').then((r) => r.default));
...
const lazyGlobalComponents = [
  ...
  ["Counter", LazyCounter],
  ["DarkToggle", LazyDarkToggle],
  ["Divider", LazyDivider],
  ["Footer", LazyFooter],
  ["ImageHover", LazyImageHover],
  ["InputEntry", LazyInputEntry],
  ["LocaleNuxtLink", LazyLocaleNuxtLink],
  ["Logos", LazyLogos],
  ["PageView", LazyPageView],
  ["Typography", LazyTypography],
  ["BrandLogo", LazyBrandLogo],
  ["Header", LazyHeader],
  ["HeaderNav", LazyHeaderNav],
  ["ModelContent", LazyModelContent],
  ["Model", LazyModel],
  ["SectionBanner", LazySectionBanner],
  ["SectionGradientCard", LazySectionGradientCard],
  ["Section", LazySection],
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_...all_-408b35ad.mjs').then((m) => m.default || m)
  },
  {
    name: "all___zh",
    path: "/:all(.*)*",
  ...
  },
  {
    ...
    component: () => import('./_nuxt/_id_-ef6c02e1.mjs').then((m) => m.default || m)
  },
  {
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-6a8753a8.mjs').then((m) => m.default || m)
  },
  {
    name: "index___zh",
    path: "/",
  ...
  },
  {
    ...
    children: [
      {
        ...
        alias: [],
        redirect: void 0,
        component: () => import('./_nuxt/_id_-4917b3a4.mjs').then((m) => m.default || m)
      },
      {
        name: "release___en",
        path: "",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/release-047386ce.mjs').then((m) => m.default || m)
  },
  {
    path: "/release",
    children: [
...
const layouts = {
  default: () => import('./_nuxt/default-51417400.mjs').then((m) => m.default || m),
  home: () => import('./_nuxt/home-d3c88f12.mjs').then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-26cc848d.mjs').then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-b3eda904.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export { __nuxt_component_0 as _, useRequestFetch as a, useTimeAgo as b, createError as c, useRoute as d, entry$1 as default, useHead as e, useRuntimeConfig as f, useState as g, useCycleList as h, useI18n as i, useLocalePath as j, getComposer as k, useNuxtApp as l, useSwitchLocalePath as m, navigateTo as n, useRequestEvent as o, defineStore as p, useElementVisibility as q, useRouter as u };
