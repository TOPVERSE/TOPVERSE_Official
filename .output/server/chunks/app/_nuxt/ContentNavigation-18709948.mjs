...
import { u as useAsyncData } from './asyncData-9174909f.mjs';
import { g as useState, f as useRuntimeConfig } from '../server.mjs';
import { hash } from 'ohash';
import { _ as __nuxt_component_0 } from './nuxt-link-15b2078b.mjs';
import { q as queryContent, e as encodeQueryParams, j as jsonStringify } from './query-0de977ef.mjs';
import { u as useContentDisabled, w as withContentBase, a as addPrerenderPath, s as shouldUseClientDB } from './utils-f0bc7ca0.mjs';
import { u as useContentPreview } from './preview-04e44f77.mjs';
import 'ofetch';
import 'hookable';
import 'unctx';
import 'h3';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-2a398c90.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-18709948.mjs.map
