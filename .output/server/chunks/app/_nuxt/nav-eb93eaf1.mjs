import { u as useSwitchLocalePath, _ as _sfc_main$1 } from './LocaleNuxtLink-9e62e7b2.mjs';
import { ABtn, AMenu, AList, AListItem, AAvatar } from 'anu-vue';
import { j as useI18n } from '../server.mjs';
import { defineComponent, computed, unref, withCtx, createVNode, openBlock, createBlock, Fragment, renderList, createCommentVNode, toDisplayString, createTextVNode, useSSRContext } from 'vue';
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(_component_ABtn, { variant: "text" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`${ssrInterpolate(flag[locale2.code])}`);
                  } else {
                    return [
                      createTextVNode(toDisplayString(flag[locale2.code]), 1)
                    ];
                  }
                }),
                _: 2
...
//# sourceMappingURL=nav-eb93eaf1.mjs.map
